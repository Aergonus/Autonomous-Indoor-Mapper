...
L298N wheels(pinLeftMotor1, pinLeftMotor2, pinRightMotor1, pinRightMotor2, 0, 0, 255);
...
int state = 0, orient = 0, xcor = 0, ycor = 0, dist = 0; 
...
void loop() {
  ...
  dist = (cm[PING_FRONT_LEFT] == 0 ? cm[PING_FRONT_RIGHT] : cm[PING_FRONT_LEFT])/2
